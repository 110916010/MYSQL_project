...
<h1 style="text-align:center"><span style="font-family:Comic Sans MS,cursive"><span style="font-size:22px"><strong>我要買書</strong></span></span></h1>

<form action="handle_add_to_shooping_cart.php" method="POST">
...
<p style="text-align:right"><input type="submit" value="我好喜歡，加入購物車！" /></p>
</div>
</form>
